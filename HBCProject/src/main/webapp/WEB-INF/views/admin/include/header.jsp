    ...
    <!-- preloader -->
      ...
      <header class="main-header">
        ...
        <a href="/admin/main" class="logo">
          ...
          <span class="logo-lg">SD 포털 <b>관리자모드</b></span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
               ...
               <span>프로그램 관리</span> <i class="fa fa-angle-left pull-right"></i>
               <!--  <span class="label label-primary pull-right">4</span> -->
              </a>
              <ul class="treeview-menu">
                <li><a href="/admin/program/list"><i class="fa fa-magic"></i> 프로그램 목록</a></li>
                <li><a href="/admin/imgBoard/list"><i class="fa fa-magic"></i> 프로그램 이미지 목록</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="/admin/notice/list"><i class="fa fa-magic"></i> 공지사항 목록</a></li>
                <li><a href="/admin/imgGallery/list"><i class="fa fa-magic"></i> SD갤러리 목록</a></li>
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-book"></i> <span>PR관리</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="/admin/news/list"><i class="fa fa-magic"></i> 보도자료 목록</a></li>
                <li><a href="/admin/review/list"><i class="fa fa-magic"></i> 수강후기 목록</a></li>
              </ul>
             </li>
             <li class="treeview">
              <a href="#">
