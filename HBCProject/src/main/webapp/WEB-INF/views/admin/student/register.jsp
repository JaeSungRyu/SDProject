				...
				<form role="form" method="post" class="form-horizontal">
					...
					<div class="box-body box-form-custom">
						...
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<select name="compnum" id="compnum" class="form-control" onchange="compSelect(this.value)">
						...
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<input id="cellPhone" type="text" name='stuphone' maxlength="13" class="form-control" placeholder="ex) 01011112222">
						...
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<input type="text" name='stuemail' class="form-control" placeholder="이메일 주소를 입력해주세요">
