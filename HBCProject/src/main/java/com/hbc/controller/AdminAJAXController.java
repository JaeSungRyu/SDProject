...
public class AdminAJAXController
{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/admin/user/validate", method = RequestMethod.POST)
	@ResponseBody
	public AdminValidationDTO validate(@RequestBody AdminVO admin) throws Exception
	{
		// AdminValidationDTO 객체를 서비스에서 받아옴
		// 이 객체에는 유효성검사 결과가 들어있음
		AdminValidationDTO msg = service.validate(admin);
